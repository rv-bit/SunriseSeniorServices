import React, { useCallback, useRef, useContext, useEffect, useState, useLayoutEffect } from 'react'
...
const Chat = () => {
    ...
    useEffect(() => {
        ...
        if (selectedChatId) {
            ...
            socket = io(urlSocket, {autoConnect: false});
            ...
            socket.on('connect', () => {
                ...
                socket.on('receiveMessage', (data) => {
                    ...
                    // After receiving a message, change the last message of the chat
                    const chatIndex = chats.findIndex((chat) => chat._id === selectedChatId);
                    if (chatIndex !== -1) {
                        const newChats = [...chats];

                        newChats[chatIndex].last_message = data.message;
                        newChats[chatIndex].last_message_date = data.created_at;
